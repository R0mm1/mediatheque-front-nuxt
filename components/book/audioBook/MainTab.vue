  ...
  <div id="book-main-tab">
    ...
    <Column class="third-col">
      <template #column_content>
        <AudioGroupInformation :book-store="bookModule" :edit-mode-on="editModeOn" />
...
import AudioGroupInformation from '@/components/book/audioBook/groups/AudioGroupInformation'

export default {
  name: 'MainTab',
  components: {
    AudioGroupInformation,
    Column,
    GroupReferences,
    GroupSummary,
    GroupPicture
